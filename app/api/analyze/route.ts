...
{"keyFeatures": ["특징1", "특징2", "특징3", "특징4"], "examSummary": "시험 전체에 대한 종합 총평을 3~5문장으로 작성. 난이도 수준, 출제 경향, 변별력 포인트 등을 포함.", "commonMistakes": [{"area": "실수가 많이 발생하는 영역/단원", "description": "학생들이 구체적으로 어떤 실수를 하는지, 왜 틀리는지 설명", "tip": "실수 방지를 위한 구체적 팁"}], "yearOverYearComparison": "${hasPrev ? '전년도와 비교 2~3문장' : '전년도 시험지 없음. 이번 시험 특성만 서술.'}"}
